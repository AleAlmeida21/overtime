<?php
/* Smarty version 3.1.33, created on 2021-08-23 16:29:04
  from '/home/grouaknd/public_html/Campanas/templates/Admin/acceso.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_6123f700eaf601_95820872',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3cdc2f65113138d41b2d54af38d850daf31f8f0f' => 
    array (
      0 => '/home/grouaknd/public_html/Campanas/templates/Admin/acceso.tpl',
      1 => 1629732752,
      2 => 'file',
    ),
  ),
...
function content_6123f700eaf601_95820872 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
?>
    ...
    <!-- Title Page-->
    <title>Campaña - Accesos FB</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Accesos FB</strong> Mantenimiento
                                    </div>
                                    <div class="card-body card-block">
                                        <form id="formulario">
                                            <div class="row form-group">
                                                <div class="col col-md-2">
                                                    <label for="text-input" class=" form-control-label">APP ID</label>
                                                </div>
                                                <div class="col-12 col-md-10">
                                                    <input type="text" name="appid" placeholder="AppID de Facebook" class="form-control" id="appid" value="<?php echo $_smarty_tpl->tpl_vars['appid']->value;?>
">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-10">
                                                    <input type="text" name="secret" placeholder="Aecret de Facebook" class="form-control" id="secret" value="<?php echo $_smarty_tpl->tpl_vars['secret']->value;?>
">                                              
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-2">
                                                    <label for="text-input" class=" form-control-label">TOKEN</label>
                                                </div>
                                                <div class="col-12 col-md-10">
                                                    <input type="text" name="token" placeholder="Token de Facebook" class="form-control" id="token" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
">
                                                </div>
                                            </div>                                                    
                                        </form>
...
?>
        <?php echo '<script'; ?>
 type="text/javascript" src="js/acceso.js"><?php echo '</script'; ?>
>
