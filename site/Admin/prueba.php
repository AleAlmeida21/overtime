...
try {
  ...
  $response = (array)$fb->get('/23847817099850787?fields=end_time,start_time,targeting,optimization_goal,lifetime_budget');
...
////        print_r($valor);
////        echo "<hr>";
//        echo $valor["start_time"] . "<br>"; 
//        echo $valor["end_time"] . "<br>"; 
//        echo $valor["lifetime_budget"] . "<br>"; 
//        echo $valor["targeting"]["age_min"] . "<br>"; 
//        echo $valor["targeting"]["age_max"] . "<br>"; 
//        echo $valor["targeting"]["geo_locations"]["countries"][0] . "<br>"; 
//    }
//}
?>